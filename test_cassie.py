...
#                                      Step
    ...
    # Built reward functions for robot to walking around
        ...
        rewards = {
            ...
            'orientation penalty':(
                -0.5*self._orientation_penalty(body_pos)),
...
#                                  Reward functions
    ...
    def _joint_torque_penalty(self,
        ...
        """
        penalty term for L2 norm and L1 norm of the total torques
...
model_path = '/home/icepomelo/Code/policy_walking_final'
full_path = '/home/icepomelo/Code/inference_walking_final'
